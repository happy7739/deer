<?php /*a:48:{s:59:"F:\Project\deer\application\common/builder/form/layout.html";i:1579407356;s:50:"F:\Project\deer\application\admin/view/layout.html";i:1579404556;s:47:"../application/common/builder/aside/layout.html";i:1551348862;s:54:"../application/common/builder/aside/blocks/recent.html";i:1551348862;s:54:"../application/common/builder/aside/blocks/online.html";i:1551348862;s:54:"../application/common/builder/aside/blocks/switch.html";i:1551348862;s:53:"../application/common/builder/form/items/archive.html";i:1551348862;s:54:"../application/common/builder/form/items/archives.html";i:1551348862;s:50:"../application/common/builder/form/items/bmap.html";i:1544253712;s:52:"../application/common/builder/form/items/button.html";i:1525873522;s:54:"../application/common/builder/form/items/checkbox.html";i:1551348862;s:54:"../application/common/builder/form/items/ckeditor.html";i:1551348862;s:57:"../application/common/builder/form/items/colorpicker.html";i:1551348862;s:50:"../application/common/builder/form/items/date.html";i:1551348862;s:55:"../application/common/builder/form/items/daterange.html";i:1551348862;s:54:"../application/common/builder/form/items/datetime.html";i:1551348862;s:54:"../application/common/builder/form/items/editormd.html";i:1551348862;s:50:"../application/common/builder/form/items/file.html";i:1551348862;s:51:"../application/common/builder/form/items/files.html";i:1551348862;s:53:"../application/common/builder/form/items/gallery.html";i:1569825626;s:51:"../application/common/builder/form/items/group.html";i:1547521040;s:52:"../application/common/builder/form/items/hidden.html";i:1495847800;s:50:"../application/common/builder/form/items/icon.html";i:1551348862;s:51:"../application/common/builder/form/items/image.html";i:1551348862;s:52:"../application/common/builder/form/items/images.html";i:1551348862;s:51:"../application/common/builder/form/items/jcrop.html";i:1551348862;s:53:"../application/common/builder/form/items/linkage.html";i:1551348862;s:54:"../application/common/builder/form/items/linkages.html";i:1551348862;s:52:"../application/common/builder/form/items/masked.html";i:1551348862;s:52:"../application/common/builder/form/items/number.html";i:1551348862;s:54:"../application/common/builder/form/items/password.html";i:1551348862;s:51:"../application/common/builder/form/items/radio.html";i:1551348862;s:51:"../application/common/builder/form/items/range.html";i:1551348862;s:52:"../application/common/builder/form/items/select.html";i:1551348862;s:53:"../application/common/builder/form/items/select2.html";i:1551348862;s:50:"../application/common/builder/form/items/sort.html";i:1551348862;s:52:"../application/common/builder/form/items/static.html";i:1551348862;s:56:"../application/common/builder/form/items/summernote.html";i:1551348862;s:52:"../application/common/builder/form/items/switch.html";i:1551348862;s:50:"../application/common/builder/form/items/tags.html";i:1551348862;s:50:"../application/common/builder/form/items/text.html";i:1551348862;s:50:"../application/common/builder/form/items/time.html";i:1551348862;s:54:"../application/common/builder/form/items/textarea.html";i:1551348862;s:53:"../application/common/builder/form/items/ueditor.html";i:1551348862;s:56:"../application/common/builder/form/items/wangeditor.html";i:1551348862;s:47:"../application/common/builder/form/icon/fa.html";i:1489042526;s:47:"../application/common/builder/form/icon/gl.html";i:1489042526;s:47:"../application/common/builder/form/icon/sl.html";i:1489042526;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <link href="/static/libs/editormd/css/editormd.min.css?v=<?php echo config('asset_version'); ?>" rel="stylesheet" type="text/css" />
    ...
    <?php endforeach; endif; else: echo "" ;endif; if(is_array($extend_css_list) || $extend_css_list instanceof \think\Collection || $extend_css_list instanceof \think\Paginator): $i = 0; $__LIST__ = $extend_css_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <link rel="stylesheet" href="<?php echo htmlentities($v); ?>?v=<?php echo config('asset_version'); ?>">
        <?php endforeach; endif; else: echo "" ;endif; ?>
    <?php endforeach; endif; else: echo "" ;endif; ?>
...
<!-- END Side Content -->
        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <a href="<?php echo htmlentities($tab['url']); if(!empty($_pop)) echo '?_pop=1'; ?>"><?php echo htmlentities($tab['title']); ?></a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <li class="pull-right">
                ...
                <div class="block-header bg-gray-lighter">
                    ...
                    <h3 class="block-title"><?php echo htmlentities((isset($page_title) && ($page_title !== '')?$page_title:"")); ?></h3>
                </div>
                <?php endif; ?>
                <?php endif; ?>
                <div class="tab-content">
                    <div class="tab-pane active">
                        <div class="block-content">
                            <?php echo (isset($extra_html_form_top) && ($extra_html_form_top !== '')?$extra_html_form_top:''); ?>
                            <form class="form-builder row" name="form-builder" action="<?php echo htmlentities((isset($post_url) && ($post_url !== '')?$post_url:'')); ?>" method="<?php echo htmlentities($_method); ?>">
                                <?php if(!(empty($_token_name) || (($_token_name instanceof \think\Collection || $_token_name instanceof \think\Paginator ) && $_token_name->isEmpty()))): ?>
                                    <?php echo token($_token_name, $_token_value); ?>
                                <?php endif; if(empty($form_items) || (($form_items instanceof \think\Collection || $form_items instanceof \think\Paginator ) && $form_items->isEmpty())): if(!(empty($empty_tips) || (($empty_tips instanceof \think\Collection || $empty_tips instanceof \think\Paginator ) && $empty_tips->isEmpty()))): ?>
                                    <div class="form-empty">
                                        <p class="text-center text-muted empty-info">
                                            <i class="fa fa-database"></i> <?php echo $empty_tips; ?><br>
                                        </p>
                                    </div>
                                    <?php endif; else: if(is_array($form_items) || $form_items instanceof \think\Collection || $form_items instanceof \think\Paginator): $i = 0; $__LIST__ = $form_items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form): $mod = ($i % 2 );++$i;switch($form['type']): case "archive": ?>
                                                
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <ul class="list-group uploader-list" id="file_list_<?php echo htmlentities($form['name']); ?>">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): ?>
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo htmlentities(get_file_name($form['value'])); ?> [<a
                    href="<?php echo htmlentities(get_file_path($form['value'])); ?>" class="download-file">下载</a>]</li>
            <?php endif; ?>
        </ul>
    ...
    <div class="col-xs-12">
        <ul class="list-group uploader-list" id="file_list_<?php echo htmlentities($form['name']); ?>">
            ...
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo htmlentities(get_file_name($vo)); ?> [<a
                    href="<?php echo htmlentities(get_file_path($vo)); ?>" class="download-file">下载</a>]</li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </ul>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; case "bmap": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> js-bmap <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" data-level="<?php echo $form['level']=='' ? 12  : htmlentities($form['level']); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="form-control bmap-address" id="bmap-address-<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>_address" type="text" value="<?php echo htmlentities((isset($form['address']) && ($form['address'] !== '')?$form['address']:'')); ?>" placeholder="请输入要搜索的地址">
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo htmlentities(clear_js($form['tips'])); ?></div>
        <?php endif; ?>
        <div class="searchResultPanel"></div>
        <input class="form-control bmap-point" type="hidden" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
        <div class="bmap push-10-t" id="bmap-canvas-<?php echo htmlentities($form['name']); ?>"></div>
    </div>
</div>

<script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=<?php echo htmlentities((isset($form['ak']) && ($form['ak'] !== '')?$form['ak']:'')); ?>"></script>
                                            <?php break; case "button": ?>
                                                
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <div class="col-xs-12 form-btn-parent">
        <?php if($form['ele_type'] == 'button'): ?>
        <button class="form-btn btn  <?php echo htmlentities((isset($form['class']) && ($form['class'] !== '')?$form['class']:'btn-primary')); ?>" id="<?php echo htmlentities((isset($form['id']) && ($form['id'] !== '')?$form['id']:'')); ?>" type="button" <?php echo htmlentities((isset($form['data']) && ($form['data'] !== '')?$form['data']:'')); if(isset($form['disabled'])): ?>disabled<?php endif; ?>><i class="<?php echo htmlentities((isset($form['icon']) && ($form['icon'] !== '')?$form['icon']:'')); ?>"></i> <?php echo htmlentities((isset($form['title']) && ($form['title'] !== '')?$form['title']:'')); ?></button>
        <?php else: ?>
        <a class="form-btn btn <?php echo htmlentities((isset($form['class']) && ($form['class'] !== '')?$form['class']:'btn-primary')); if(isset($form['disabled'])): ?> disabled<?php endif; ?>" id="<?php echo htmlentities((isset($form['id']) && ($form['id'] !== '')?$form['id']:'')); ?>" title="<?php echo htmlentities((isset($form['title']) && ($form['title'] !== '')?$form['title']:'')); ?>" target="<?php echo htmlentities((isset($form['target']) && ($form['target'] !== '')?$form['target']:'_self')); ?>" href="<?php echo htmlentities((isset($form['href']) && ($form['href'] !== '')?$form['href']:'')); ?>" <?php echo htmlentities((isset($form['data']) && ($form['data'] !== '')?$form['data']:'')); ?>><i class="<?php echo htmlentities((isset($form['icon']) && ($form['icon'] !== '')?$form['icon']:'')); ?>"></i> <?php echo htmlentities((isset($form['title']) && ($form['title'] !== '')?$form['title']:'')); ?></a>
        <?php endif; ?>
    </div>
</div>
                                            <?php break; case "checkbox": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        ...
        <label class="css-input css-checkbox css-checkbox-<?php echo htmlentities((isset($form['attr']['color']) && ($form['attr']['color'] !== '')?$form['attr']['color']:'primary')); ?> css-checkbox-<?php echo htmlentities((isset($form['attr']['size']) && ($form['attr']['size'] !== '')?$form['attr']['size']:'sm')); ?> css-checkbox-<?php echo htmlentities((isset($form['attr']['shape']) && ($form['attr']['shape'] !== '')?$form['attr']['shape']:'rounded')); ?>  <?php echo htmlentities((isset($form['extra_label_class']) && ($form['extra_label_class'] !== '')?$form['extra_label_class']:'')); ?>">
            <input type="checkbox" name="<?php echo htmlentities($form['name']); ?>[]" id="<?php echo htmlentities($form['name']); ?><?php echo htmlentities($key); ?>" value="<?php echo htmlentities($key); ?>" <?php $key = (string)$key; if(in_array(($key), is_array((isset($form['value']) && ($form['value'] !== '')?$form['value']:''))?(isset($form['value']) && ($form['value'] !== '')?$form['value']:''):explode(',',(isset($form['value']) && ($form['value'] !== '')?$form['value']:'')))): ?>checked<?php endif; ?> <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>><span></span> <?php echo htmlspecialchars($option); ?>
        </label>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="js-ckeditor form-control" id="<?php echo htmlentities($form['name']); ?>" data-width="<?php echo htmlentities((isset($form['width']) && ($form['width'] !== '')?$form['width']:'100%')); ?>" data-height="<?php echo htmlentities((isset($form['height']) && ($form['height'] !== '')?$form['height']:400)); ?>" name="<?php echo htmlentities($form['name']); ?>" placeholder="请输入<?php echo htmlentities($form['title']); ?>"><?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?></textarea>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <div class="js-colorpicker input-group" data-colorpicker-mode="<?php echo $form['mode']=='' ? 'rgba'  : htmlentities($form['mode']); ?>">
            <input class="form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="请从右边选择颜色" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-datepicker form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" data-date-format="<?php echo !empty($form['format']) ? htmlentities($form['format']) :  'yyyy-mm-dd'; ?>" placeholder="<?php echo htmlentities($form['format']); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
                                            ...
                                            <?php break; case "daterange": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name_from']]['lg']) && ($_layout[$form['name_from']]['lg'] !== '')?$_layout[$form['name_from']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name_from']]['md']) && ($_layout[$form['name_from']]['md'] !== '')?$_layout[$form['name_from']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name_from']]['sm']) && ($_layout[$form['name_from']]['sm'] !== '')?$_layout[$form['name_from']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name_from']]['xs']) && ($_layout[$form['name_from']]['xs'] !== '')?$_layout[$form['name_from']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['id']); ?>">
    <label class="col-xs-12"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <div class="input-daterange input-group" data-date-format="<?php echo !empty($form['format']) ? htmlentities($form['format']) :  'yyyy-mm-dd'; ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            <input class="form-control" type="text" id="<?php echo htmlentities($form['id_from']); ?>" name="<?php echo htmlentities($form['name_from']); ?>" value="<?php echo htmlentities((isset($form['value_from']) && ($form['value_from'] !== '')?$form['value_from']:'')); ?>" placeholder="<?php echo htmlentities($form['format']); ?>">
            <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
            <input class="form-control" type="text" id="<?php echo htmlentities($form['id_to']); ?>" name="<?php echo htmlentities($form['name_to']); ?>" value="<?php echo htmlentities((isset($form['value_to']) && ($form['value_to'] !== '')?$form['value_to']:'')); ?>" placeholder="<?php echo htmlentities($form['format']); ?>">
        </div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-datetimepicker form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="<?php echo htmlentities($form['format']); ?>" data-side-by-side="true" data-locale="zh-cn" data-format="<?php echo !empty($form['format']) ? htmlentities($form['format']) :  'YYYY-MM-DD HH:mm'; ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
...
<div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <div id="<?php echo htmlentities($form['name']); ?>">
            <textarea style="display:none;" class="js-editormd" data-image-formats='<?php echo htmlentities((isset($upload_image_ext) && ($upload_image_ext !== '')?$upload_image_ext:"")); ?>' data-watch="<?php echo htmlentities((isset($form['watch']) && ($form['watch'] !== '')?$form['watch']:true)); ?>" name="<?php echo htmlentities($form['name']); ?>"><?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?></textarea>
        </div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
                                            ...
                                            <?php break; case "file": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12 js-upload-file">
        <ul class="list-group uploader-list" id="file_list_<?php echo htmlentities($form['name']); ?>">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): ?>
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo htmlentities(get_file_name($form['value'])); ?> [<a
                    href="<?php echo htmlentities(get_file_path($form['value'])); ?>" class="download-file">下载</a>] [<a
                    href="javascript:void(0);" class="remove-file">删除</a>]</li>
            <?php endif; ?>
        </ul>
        <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" data-multiple="false" data-size="<?php echo htmlentities((isset($form['size']) && ($form['size'] !== '')?$form['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form["ext"]) && ($form["ext"] !== '')?$form["ext"]:"")); ?>' id="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form['name']); ?>">上传单个文件</div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
                                            ...
                                            <?php break; case "files": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12 js-upload-files">
        <ul class="list-group uploader-list" id="file_list_<?php echo htmlentities($form['name']); ?>">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): if(is_array(explode(',',$form['value'])) || explode(',',$form['value']) instanceof \think\Collection || explode(',',$form['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo htmlentities(get_file_name($vo)); ?> [<a
                        href="<?php echo htmlentities(get_file_path($vo)); ?>" class="download-file">下载</a>] [<a
                        href="javascript:void(0);" class="remove-file" data-id="<?php echo htmlentities($vo); ?>">删除</a>]</li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </ul>
        <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" data-multiple="true" data-size="<?php echo htmlentities((isset($form['size']) && ($form['size'] !== '')?$form['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form["ext"]) && ($form["ext"] !== '')?$form["ext"]:"")); ?>' id="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form['name']); ?>">上传多个文件</div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <div id="file_list_<?php echo htmlentities($form['name']); ?>" class="gallery-list">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): if(is_array(explode(',',$form['value'])) || explode(',',$form['value']) instanceof \think\Collection || explode(',',$form['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="file-item thumbnail">
                <?php if(is_numeric($vo)): ?>
                <img data-original="<?php echo htmlentities(get_file_path($vo)); ?>" src="<?php echo htmlentities(get_thumb($vo)); ?>" width="100">
                <?php else: ?>
                <img data-original="<?php echo htmlentities($vo); ?>" src="<?php echo htmlentities($vo); ?>" width="100">
                <?php endif; ?>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="block block-bordered">
            <ul class="nav nav-tabs" data-toggle="tabs" id="builder-form-group-tab">
                ...
                <a href="#tab-<?php echo htmlentities($items_key); ?>"><?php echo htmlentities(htmlspecialchars($key)); ?></a>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div class="block-content tab-content block-group">
                ...
                <div class="tab-pane row <?php if($items_key == '1'): ?>active<?php endif; ?>" id="tab-<?php echo htmlentities($items_key); ?>" >
                    <?php if(is_array($items) || $items instanceof \think\Collection || $items instanceof \think\Paginator): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form_group): $mod = ($i % 2 );++$i;switch($form_group['type']): case "archive": ?>
                                
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <ul class="list-group uploader-list" id="file_list_<?php echo htmlentities($form_group['name']); ?>">
            ...
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo htmlentities(get_file_name($form_group['value'])); ?> [<a
                    href="<?php echo htmlentities(get_file_path($form_group['value'])); ?>" class="download-file">下载</a>]</li>
            <?php endif; ?>
        </ul>
    ...
    <div class="col-xs-12">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "bmap": ?>
                                ...
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?> js-bmap <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" data-level="<?php echo $form_group['level']=='' ? 12  : htmlentities($form_group['level']); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="form-control bmap-address" id="bmap-address-<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>_address" type="text" value="<?php echo htmlentities((isset($form_group['address']) && ($form_group['address'] !== '')?$form_group['address']:'')); ?>" placeholder="请输入要搜索的地址">
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo htmlentities(clear_js($form_group['tips'])); ?></div>
        <?php endif; ?>
        <div class="searchResultPanel"></div>
        <input class="form-control bmap-point" type="hidden" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
        <div class="bmap push-10-t" id="bmap-canvas-<?php echo htmlentities($form_group['name']); ?>"></div>
    </div>
</div>

<script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=<?php echo htmlentities((isset($form_group['ak']) && ($form_group['ak'] !== '')?$form_group['ak']:'')); ?>"></script>
                            <?php break; case "button": ?>
                                
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <div class="col-xs-12 form-btn-parent">
        <?php if($form_group['ele_type'] == 'button'): ?>
        <button class="form-btn btn  <?php echo htmlentities((isset($form_group['class']) && ($form_group['class'] !== '')?$form_group['class']:'btn-primary')); ?>" id="<?php echo htmlentities((isset($form_group['id']) && ($form_group['id'] !== '')?$form_group['id']:'')); ?>" type="button" <?php echo htmlentities((isset($form_group['data']) && ($form_group['data'] !== '')?$form_group['data']:'')); if(isset($form_group['disabled'])): ?>disabled<?php endif; ?>><i class="<?php echo htmlentities((isset($form_group['icon']) && ($form_group['icon'] !== '')?$form_group['icon']:'')); ?>"></i> <?php echo htmlentities((isset($form_group['title']) && ($form_group['title'] !== '')?$form_group['title']:'')); ?></button>
        <?php else: ?>
        <a class="form-btn btn <?php echo htmlentities((isset($form_group['class']) && ($form_group['class'] !== '')?$form_group['class']:'btn-primary')); if(isset($form_group['disabled'])): ?> disabled<?php endif; ?>" id="<?php echo htmlentities((isset($form_group['id']) && ($form_group['id'] !== '')?$form_group['id']:'')); ?>" title="<?php echo htmlentities((isset($form_group['title']) && ($form_group['title'] !== '')?$form_group['title']:'')); ?>" target="<?php echo htmlentities((isset($form_group['target']) && ($form_group['target'] !== '')?$form_group['target']:'_self')); ?>" href="<?php echo htmlentities((isset($form_group['href']) && ($form_group['href'] !== '')?$form_group['href']:'')); ?>" <?php echo htmlentities((isset($form_group['data']) && ($form_group['data'] !== '')?$form_group['data']:'')); ?>><i class="<?php echo htmlentities((isset($form_group['icon']) && ($form_group['icon'] !== '')?$form_group['icon']:'')); ?>"></i> <?php echo htmlentities((isset($form_group['title']) && ($form_group['title'] !== '')?$form_group['title']:'')); ?></a>
        <?php endif; ?>
    </div>
</div>
                            <?php break; case "checkbox": ?>
                                ...
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        ...
        <label class="css-input css-checkbox css-checkbox-<?php echo htmlentities((isset($form_group['attr']['color']) && ($form_group['attr']['color'] !== '')?$form_group['attr']['color']:'primary')); ?> css-checkbox-<?php echo htmlentities((isset($form_group['attr']['size']) && ($form_group['attr']['size'] !== '')?$form_group['attr']['size']:'sm')); ?> css-checkbox-<?php echo htmlentities((isset($form_group['attr']['shape']) && ($form_group['attr']['shape'] !== '')?$form_group['attr']['shape']:'rounded')); ?>  <?php echo htmlentities((isset($form_group['extra_label_class']) && ($form_group['extra_label_class'] !== '')?$form_group['extra_label_class']:'')); ?>">
            <input type="checkbox" name="<?php echo htmlentities($form_group['name']); ?>[]" id="<?php echo htmlentities($form_group['name']); ?><?php echo htmlentities($key); ?>" value="<?php echo htmlentities($key); ?>" <?php $key = (string)$key; if(in_array(($key), is_array((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''))?(isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''):explode(',',(isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')))): ?>checked<?php endif; ?> <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>><span></span> <?php echo htmlspecialchars($option); ?>
        </label>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="js-ckeditor form-control" id="<?php echo htmlentities($form_group['name']); ?>" data-width="<?php echo htmlentities((isset($form_group['width']) && ($form_group['width'] !== '')?$form_group['width']:'100%')); ?>" data-height="<?php echo htmlentities((isset($form_group['height']) && ($form_group['height'] !== '')?$form_group['height']:400)); ?>" name="<?php echo htmlentities($form_group['name']); ?>" placeholder="请输入<?php echo htmlentities($form_group['title']); ?>"><?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?></textarea>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <div class="js-colorpicker input-group" data-colorpicker-mode="<?php echo $form_group['mode']=='' ? 'rgba'  : htmlentities($form_group['mode']); ?>">
            <input class="form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="请从右边选择颜色" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
            <span class="input-group-addon"><i style="background-color: rgb(92, 144, 210);"></i></span>
        </div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-datepicker form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" data-date-format="<?php echo !empty($form_group['format']) ? htmlentities($form_group['format']) :  'yyyy-mm-dd'; ?>" placeholder="<?php echo htmlentities($form_group['format']); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
                            ...
                            <?php break; case "daterange": ?>
                                ...
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name_from']]['lg']) && ($_layout[$form_group['name_from']]['lg'] !== '')?$_layout[$form_group['name_from']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name_from']]['md']) && ($_layout[$form_group['name_from']]['md'] !== '')?$_layout[$form_group['name_from']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name_from']]['sm']) && ($_layout[$form_group['name_from']]['sm'] !== '')?$_layout[$form_group['name_from']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name_from']]['xs']) && ($_layout[$form_group['name_from']]['xs'] !== '')?$_layout[$form_group['name_from']]['xs']:'12')); ?> <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['id']); ?>">
    <label class="col-xs-12"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <div class="input-daterange input-group" data-date-format="<?php echo !empty($form_group['format']) ? htmlentities($form_group['format']) :  'yyyy-mm-dd'; ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
            <input class="form-control" type="text" id="<?php echo htmlentities($form_group['id_from']); ?>" name="<?php echo htmlentities($form_group['name_from']); ?>" value="<?php echo htmlentities((isset($form_group['value_from']) && ($form_group['value_from'] !== '')?$form_group['value_from']:'')); ?>" placeholder="<?php echo htmlentities($form_group['format']); ?>">
            <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
            <input class="form-control" type="text" id="<?php echo htmlentities($form_group['id_to']); ?>" name="<?php echo htmlentities($form_group['name_to']); ?>" value="<?php echo htmlentities((isset($form_group['value_to']) && ($form_group['value_to'] !== '')?$form_group['value_to']:'')); ?>" placeholder="<?php echo htmlentities($form_group['format']); ?>">
        </div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-datetimepicker form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="<?php echo htmlentities($form_group['format']); ?>" data-side-by-side="true" data-locale="zh-cn" data-format="<?php echo !empty($form_group['format']) ? htmlentities($form_group['format']) :  'YYYY-MM-DD HH:mm'; ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
...
<div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <div id="<?php echo htmlentities($form_group['name']); ?>">
            <textarea style="display:none;" class="js-editormd" data-image-formats='<?php echo htmlentities((isset($upload_image_ext) && ($upload_image_ext !== '')?$upload_image_ext:"")); ?>' data-watch="<?php echo htmlentities((isset($form_group['watch']) && ($form_group['watch'] !== '')?$form_group['watch']:true)); ?>" name="<?php echo htmlentities($form_group['name']); ?>"><?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?></textarea>
        </div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    ...
    <div class="col-xs-12 js-upload-file">
        <ul class="list-group uploader-list" id="file_list_<?php echo htmlentities($form_group['name']); ?>">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): ?>
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo htmlentities(get_file_name($form_group['value'])); ?> [<a
                    href="<?php echo htmlentities(get_file_path($form_group['value'])); ?>" class="download-file">下载</a>] [<a
                    href="javascript:void(0);" class="remove-file">删除</a>]</li>
            <?php endif; ?>
        </ul>
        <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" data-multiple="false" data-size="<?php echo htmlentities((isset($form_group['size']) && ($form_group['size'] !== '')?$form_group['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form_group["ext"]) && ($form_group["ext"] !== '')?$form_group["ext"]:"")); ?>' id="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form_group['name']); ?>">上传单个文件</div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12 js-upload-files">
        ...
        <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" data-multiple="true" data-size="<?php echo htmlentities((isset($form_group['size']) && ($form_group['size'] !== '')?$form_group['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form_group["ext"]) && ($form_group["ext"] !== '')?$form_group["ext"]:"")); ?>' id="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form_group['name']); ?>">上传多个文件</div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <div id="file_list_<?php echo htmlentities($form_group['name']); ?>" class="gallery-list">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): if(is_array(explode(',',$form_group['value'])) || explode(',',$form_group['value']) instanceof \think\Collection || explode(',',$form_group['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form_group['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="file-item thumbnail">
                <?php if(is_numeric($vo)): ?>
                <img data-original="<?php echo htmlentities(get_file_path($vo)); ?>" src="<?php echo htmlentities(get_thumb($vo)); ?>" width="100">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "hidden": ?>
                                ...
                                <div class="form-group hidden <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" value='<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:"")); ?>' class="form-control" id="<?php echo htmlentities($form_group['name']); ?>">
</div>
                            <?php break; case "icon": ?>
    ...
    <div class="col-xs-12">
        <div class="input-group js-icon-picker">
            <span class="input-group-addon icon" data-toggle="tooltip" data-placement="bottom" data-original-title="点击选择图标"><i class="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'fa fa-plus-circle')); ?>"></i></span>
            <input class="form-control icon_input" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="请选择图标" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
    ...
    <div class="col-xs-12 js-upload-image">
        <div id="file_list_<?php echo htmlentities($form_group['name']); ?>" class="uploader-list">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): ?>
            <div class="file-item thumbnail">
                <img data-original="<?php echo htmlentities(get_file_path($form_group['value'])); ?>" src="<?php echo htmlentities(get_thumb($form_group['value'])); ?>" width="100">
                <i class="fa fa-times-circle remove-picture"></i>
            </div>
            <?php endif; ?>
        </div>
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" data-multiple="false" data-watermark='<?php echo htmlentities((isset($form_group["watermark"]) && ($form_group["watermark"] !== '')?$form_group["watermark"]:"")); ?>' data-thumb='<?php echo htmlentities((isset($form_group["thumb"]) && ($form_group["thumb"] !== '')?$form_group["thumb"]:"")); ?>' data-size="<?php echo htmlentities((isset($form_group['size']) && ($form_group['size'] !== '')?$form_group['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form_group["ext"]) && ($form_group["ext"] !== '')?$form_group["ext"]:"")); ?>' id="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form_group['name']); ?>">上传单张图片</div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12 js-upload-images">
        <div id="file_list_<?php echo htmlentities($form_group['name']); ?>" class="uploader-list">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): if(is_array(explode(',',$form_group['value'])) || explode(',',$form_group['value']) instanceof \think\Collection || explode(',',$form_group['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form_group['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <div class="file-item thumbnail">
                    <img data-original="<?php echo htmlentities(get_file_path($vo)); ?>" src="<?php echo htmlentities(get_thumb($vo)); ?>" width="100">
                    <i class="fa fa-times-circle remove-picture" data-id="<?php echo htmlentities($vo); ?>"></i>
        ...
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" data-multiple="true" data-watermark='<?php echo htmlentities((isset($form_group["watermark"]) && ($form_group["watermark"] !== '')?$form_group["watermark"]:"")); ?>' data-thumb='<?php echo htmlentities((isset($form_group["thumb"]) && ($form_group["thumb"] !== '')?$form_group["thumb"]:"")); ?>' data-size="<?php echo htmlentities((isset($form_group['size']) && ($form_group['size'] !== '')?$form_group['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form_group["ext"]) && ($form_group["ext"] !== '')?$form_group["ext"]:"")); ?>' id="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form_group['name']); ?>">上传多张图片</div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
                            ...
                            <?php break; case "jcrop": ?>
                                ...
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?> js-jcrop-interface <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12 uploader-list">
        <div class="file-item thumbnail" <?php echo !empty($form_group['value']) ? htmlentities($form_group['value']) : "style='display:none'"; ?>>
            <img data-original="<?php echo htmlentities(get_file_path($form_group['value'])); ?>" src="<?php echo htmlentities(get_thumb($form_group['value'])); ?>" width="100">
            <i class="fa fa-times-circle remove-picture"></i>
        </div>
        <div class="clearfix"></div>
        ...
        <input type="hidden" class="js-jcrop-input" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    ...
                    <div class="block-content push-20">
                        <div class="jcrop-preview-parent" <?php echo !empty($form_group['value']) ? htmlentities($form_group['value']) : "style='display:none'"; ?>>
                            <img src="<?php echo htmlentities(get_file_path($form_group['value'])); ?>" class="jcrop-preview" />
                        </div>
                        <div class="jcrop-img">
                            <img src="<?php echo htmlentities(get_file_path($form_group['value'])); ?>" data-id="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" data-watermark='<?php echo htmlentities((isset($form_group["watermark"]) && ($form_group["watermark"] !== '')?$form_group["watermark"]:"")); ?>' data-thumb='<?php echo htmlentities((isset($form_group["thumb"]) && ($form_group["thumb"] !== '')?$form_group["thumb"]:"")); ?>' data-options='<?php echo htmlentities((isset($form_group['options']) && ($form_group['options'] !== '')?$form_group['options']:"")); ?>' class="js-jcrop" style="display: none;" alt="">
                        </div>
                    </div>
                </div>
    ...
    <!-- END Pop In Modal -->
                            ...
                            <?php break; case "linkage": ?>
                                ...
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(clear_js($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <select class="js-select2 form-control select-linkage" name="<?php echo htmlentities($form_group['name']); ?>" id="<?php echo htmlentities($form_group['name']); ?>" data-allow-clear="true" data-placeholder="请选择一项" data-url="<?php echo htmlentities((isset($form_group['ajax_url']) && ($form_group['ajax_url'] !== '')?$form_group['ajax_url']:'')); ?>" data-param="<?php echo htmlentities((isset($form_group['param']) && ($form_group['param'] !== '')?$form_group['param']:$form_group['name'])); ?>" data-next-items="<?php echo htmlentities($form_group['next_items']); ?>" data-extra-param="<?php echo htmlentities((isset($form_group['extra_param']) && ($form_group['extra_param'] !== '')?$form_group['extra_param']:'')); ?>">
            <option></option>
            <?php if(is_array($form_group['options']) || $form_group['options'] instanceof \think\Collection || $form_group['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form_group['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($key); ?>" <?php if(($form_group['value'] == (string)$key)): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
...
<div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    ...
    <div class="select-box">
        <select class="js-select2 form-control select-linkages" id="linkages_<?php echo htmlentities($form_group['name']); ?>_1" data-token="<?php echo htmlentities($form_group['token']); ?>" data-pidkey="<?php echo htmlentities((isset($form_group['pid']) && ($form_group['pid'] !== '')?$form_group['pid']:'pid')); ?>" data-next-level="2" data-next-level-id="linkages_<?php echo htmlentities($form_group['name']); ?>_2">
            ...
            <option value="<?php echo htmlentities($option[$form_group['key']]); ?>" <?php if((isset($level_key[1]) && $level_key[1] == (string)$option[$form_group['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form_group['option']]); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
    ...
    <div class="select-box">
        <select class="js-select2 form-control" name="<?php echo htmlentities($form_group['name']); ?>" id="linkages_<?php echo htmlentities($form_group['name']); ?>_2">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['1']) || (($level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator ) && $level_data['1']->isEmpty()))): if(is_array($level_data['1']) || $level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form_group['key']]); ?>" <?php if(($form_group['value'] == (string)$option[$form_group['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form_group['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </select>
    </div>
    ...
    <div class="select-box">
        <select class="js-select2 form-control select-linkages" id="linkages_<?php echo htmlentities($form_group['name']); ?>_2" data-token="<?php echo htmlentities($form_group['token']); ?>" data-pidkey="<?php echo htmlentities((isset($form_group['pid']) && ($form_group['pid'] !== '')?$form_group['pid']:'pid')); ?>" data-next-level="3" data-next-level-id="linkages_<?php echo htmlentities($form_group['name']); ?>_3">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['1']) || (($level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator ) && $level_data['1']->isEmpty()))): if(is_array($level_data['1']) || $level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form_group['key']]); ?>" <?php if((isset($level_key[2]) && $level_key[2] == (string)$option[$form_group['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form_group['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </select>
    </div>
    <div class="select-box">
        <select class="js-select2 form-control" name="<?php echo htmlentities($form_group['name']); ?>" id="linkages_<?php echo htmlentities($form_group['name']); ?>_3">
            <option value="">请选择：</option>
    ...
    <div class="select-box">
        <select class="js-select2 form-control select-linkages" id="linkages_<?php echo htmlentities($form_group['name']); ?>_3" data-token="<?php echo htmlentities($form_group['token']); ?>" data-pidkey="<?php echo htmlentities((isset($form_group['pid']) && ($form_group['pid'] !== '')?$form_group['pid']:'pid')); ?>" data-next-level="4" data-next-level-id="linkages_<?php echo htmlentities($form_group['name']); ?>_4">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['2']) || (($level_data['2'] instanceof \think\Collection || $level_data['2'] instanceof \think\Paginator ) && $level_data['2']->isEmpty()))): if(is_array($level_data['2']) || $level_data['2'] instanceof \think\Collection || $level_data['2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form_group['key']]); ?>" <?php if((isset($level_key[3]) && $level_key[3] == (string)$option[$form_group['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form_group['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </select>
    </div>
    <div class="select-box">
        <select class="js-select2 form-control" name="<?php echo htmlentities($form_group['name']); ?>" id="linkages_<?php echo htmlentities($form_group['name']); ?>_4">
            <option value="">请选择：</option>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-masked form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" data-format="<?php echo htmlentities((isset($form_group['format']) && ($form_group['format'] !== '')?$form_group['format']:'')); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="<?php echo htmlentities((isset($form_group['format']) && ($form_group['format'] !== '')?$form_group['format']:'')); ?>" <?php echo htmlentities((isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:'')); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="form-control" type="number" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="<?php echo htmlentities((isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请输入'.$form_group['title'])); ?>" <?php if(isset($form_group['min']) && $form_group['min'] !== ''): ?>min="<?php echo htmlentities($form_group['min']); ?>"<?php endif; if(isset($form_group['max']) && $form_group['max'] !== ''): ?>max="<?php echo htmlentities($form_group['max']); ?>"<?php endif; if(isset($form_group['step']) && $form_group['step'] !== ''): ?>step="<?php echo htmlentities($form_group['step']); ?>"<?php endif; ?> <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="form-control" type="password" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="<?php echo htmlentities((isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请输入'.$form_group['title'])); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12">
        <?php if(is_array($form_group['options']) || $form_group['options'] instanceof \think\Collection || $form_group['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form_group['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
        <label class="css-input css-radio css-radio-<?php echo htmlentities((isset($form_group['attr']['color']) && ($form_group['attr']['color'] !== '')?$form_group['attr']['color']:'primary')); ?> css-radio-<?php echo htmlentities((isset($form_group['attr']['size']) && ($form_group['attr']['size'] !== '')?$form_group['attr']['size']:'sm')); ?> push-10-r  <?php echo htmlentities((isset($form_group['extra_label_class']) && ($form_group['extra_label_class'] !== '')?$form_group['extra_label_class']:'')); ?>">
            <input type="radio" name="<?php echo htmlentities($form_group['name']); ?>" id="<?php echo htmlentities($form_group['name']); ?><?php echo htmlentities($i); ?>" value="<?php echo htmlentities($key); ?>" <?php $key = (string)$key; if($key == (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')): ?>checked<?php endif; ?> <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-rangeslider form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" data-input-values-separator="<?php echo htmlentities((isset($form_group['input_values_separator']) && ($form_group['input_values_separator'] !== '')?$form_group['input_values_separator']:';')); ?>" data-min="<?php echo htmlentities((isset($form_group['min']) && ($form_group['min'] !== '')?$form_group['min']:'')); ?>" data-max="<?php echo htmlentities((isset($form_group['max']) && ($form_group['max'] !== '')?$form_group['max']:'')); ?>" data-grid="<?php echo htmlentities((isset($form_group['grid']) && ($form_group['grid'] !== '')?$form_group['grid']:'')); ?>" data-grid-num="<?php echo htmlentities((isset($form_group['grid_num']) && ($form_group['grid_num'] !== '')?$form_group['grid_num']:'')); ?>" data-grid-snap="<?php echo htmlentities((isset($form_group['grid_snap']) && ($form_group['grid_snap'] !== '')?$form_group['grid_snap']:'')); ?>" data-from="<?php echo htmlentities((isset($form_group['from']) && ($form_group['from'] !== '')?$form_group['from']:'')); ?>" data-from-fixed="<?php echo htmlentities((isset($form_group['from_fixed']) && ($form_group['from_fixed'] !== '')?$form_group['from_fixed']:'')); ?>" data-type="<?php echo htmlentities((isset($form_group['double']) && ($form_group['double'] !== '')?$form_group['double']:'')); ?>" data-to="<?php echo htmlentities((isset($form_group['to']) && ($form_group['to'] !== '')?$form_group['to']:'')); ?>" data-to-fixed="<?php echo htmlentities((isset($form_group['to_fixed']) && ($form_group['to_fixed'] !== '')?$form_group['to_fixed']:'')); ?>" data-step="<?php echo htmlentities((isset($form_group['step']) && ($form_group['step'] !== '')?$form_group['step']:'')); ?>" data-from-min="<?php echo htmlentities((isset($form_group['from_min']) && ($form_group['from_min'] !== '')?$form_group['from_min']:'')); ?>" data-from-max="<?php echo htmlentities((isset($form_group['from_max']) && ($form_group['from_max'] !== '')?$form_group['from_max']:'')); ?>" data-to-min="<?php echo htmlentities((isset($form_group['to_min']) && ($form_group['to_min'] !== '')?$form_group['to_min']:'')); ?>" data-to-max="<?php echo htmlentities((isset($form_group['to_max']) && ($form_group['to_max'] !== '')?$form_group['to_max']:'')); ?>" data-from-shadow="<?php echo htmlentities((isset($form_group['from_shadow']) && ($form_group['from_shadow'] !== '')?$form_group['from_shadow']:'')); ?>" data-to-shadow="<?php echo htmlentities((isset($form_group['to_shadow']) && ($form_group['to_shadow'] !== '')?$form_group['to_shadow']:'')); ?>" data-keyboard="<?php echo htmlentities((isset($form_group['keyboard']) && ($form_group['keyboard'] !== '')?$form_group['keyboard']:'')); ?>" data-keyboard-step="<?php echo htmlentities((isset($form_group['keyboard_step']) && ($form_group['keyboard_step'] !== '')?$form_group['keyboard_step']:'')); ?>" data-values="<?php echo htmlentities((isset($form_group['values']) && ($form_group['values'] !== '')?$form_group['values']:'')); ?>" data-prefix="<?php echo htmlentities((isset($form_group['prefix']) && ($form_group['prefix'] !== '')?$form_group['prefix']:'')); ?>" data-disable="<?php echo htmlentities((isset($form_group['disable']) && ($form_group['disable'] !== '')?$form_group['disable']:'')); ?>" data-postfix="<?php echo htmlentities((isset($form_group['postfix']) && ($form_group['postfix'] !== '')?$form_group['postfix']:'')); ?>" data-min-interval="<?php echo htmlentities((isset($form_group['min_interval']) && ($form_group['min_interval'] !== '')?$form_group['min_interval']:'')); ?>" data-max-interval="<?php echo htmlentities((isset($form_group['max_interval']) && ($form_group['max_interval'] !== '')?$form_group['max_interval']:'')); ?>" data-drag-interval="<?php echo htmlentities((isset($form_group['drag_interval']) && ($form_group['drag_interval'] !== '')?$form_group['drag_interval']:'')); ?>" data-prettify-enabled="<?php echo htmlentities((isset($form_group['prettify_enabled']) && ($form_group['prettify_enabled'] !== '')?$form_group['prettify_enabled']:'')); ?>" data-prettify-separator="<?php echo htmlentities((isset($form_group['prettify_separator']) && ($form_group['prettify_separator'] !== '')?$form_group['prettify_separator']:'')); ?>" data-max-postfix="<?php echo htmlentities((isset($form_group['max_postfix']) && ($form_group['max_postfix'] !== '')?$form_group['max_postfix']:'')); ?>" data-decorate-both="<?php echo htmlentities((isset($form_group['decorate_both']) && ($form_group['decorate_both'] !== '')?$form_group['decorate_both']:'')); ?>" data-values-separator="<?php echo htmlentities((isset($form_group['values_separator']) && ($form_group['values_separator'] !== '')?$form_group['values_separator']:'')); ?>" data-hide-min-max="<?php echo htmlentities((isset($form_group['hide_min_max']) && ($form_group['hide_min_max'] !== '')?$form_group['hide_min_max']:'')); ?>" data-hide-from-to="<?php echo htmlentities((isset($form_group['hide_from_to']) && ($form_group['hide_from_to'] !== '')?$form_group['hide_from_to']:'')); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <select class="js-select2 form-control" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" data-allow-clear="true" data-placeholder="<?php echo htmlentities((isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请选择一项')); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
            <option></option>
            <?php if(is_array($form_group['options']) || $form_group['options'] instanceof \think\Collection || $form_group['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form_group['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
            <option value="<?php echo htmlentities($key); ?>" <?php if(((string)$form_group['value'] == (string)$key)): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <select class="js-select2 form-control" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>[]" data-allow-clear="true" data-placeholder="<?php echo htmlentities((isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请选择一项或多项')); ?>" multiple="multiple" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
            ...
            <option value="<?php echo htmlentities($key); ?>" <?php if(in_array(($key), is_array($form_group['value'])?$form_group['value']:explode(',',$form_group['value']))): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
                            ...
                            <?php break; case "sort": ?>
                                ...
                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form_group['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>">
    <div class="col-xs-12">
        <?php if(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty())): ?>
            <div class="form-control-static">暂无数据，无法排序</div>
        <?php else: ?>
            <div class="dd nestable" data-name="<?php echo htmlentities($form_group['name']); ?>">
                <ol class="dd-list">
                    ...
                    <li class="dd-item" data-id="<?php echo htmlentities($key); ?>">
                        <div class="dd-handle dd3-handle">拖拽</div><div class="dd3-content"><?php echo htmlentities(htmlspecialchars($item)); ?></div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ol>
            </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <div class="form-control-static"><?php echo htmlentities(htmlspecialchars((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''))); ?></div>
        <?php if(!(empty($form_group['hidden']) || (($form_group['hidden'] instanceof \think\Collection || $form_group['hidden'] instanceof \think\Paginator ) && $form_group['hidden']->isEmpty()))): ?>
        <input type="hidden" name="<?php echo htmlentities($form_group['name']); ?>" value='<?php echo htmlentities((isset($form_group['hidden']) && ($form_group['hidden'] !== '')?$form_group['hidden']:"")); ?>'>
        <?php endif; if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="js-summernote form-control" id="<?php echo htmlentities($form_group['name']); ?>" data-width="<?php echo htmlentities((isset($form_group['width']) && ($form_group['width'] !== '')?$form_group['width']:'100%')); ?>" data-height="<?php echo htmlentities((isset($form_group['height']) && ($form_group['height'] !== '')?$form_group['height']:400)); ?>" name="<?php echo htmlentities($form_group['name']); ?>" placeholder="请输入<?php echo htmlentities($form_group['title']); ?>"><?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?></textarea>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <label class="css-input switch switch-<?php echo htmlentities((isset($form_group['attr']['size']) && ($form_group['attr']['size'] !== '')?$form_group['attr']['size']:'sm')); ?> switch-<?php echo htmlentities((isset($form_group['attr']['color']) && ($form_group['attr']['color'] !== '')?$form_group['attr']['color']:'primary')); ?> switch-<?php echo htmlentities((isset($form_group['attr']['shape']) && ($form_group['attr']['shape'] !== '')?$form_group['attr']['shape']:'rounded')); ?> <?php echo htmlentities((isset($form_group['extra_label_class']) && ($form_group['extra_label_class'] !== '')?$form_group['extra_label_class']:'')); ?>" title="开启/关闭">
            <input type="checkbox" name="<?php echo htmlentities($form_group['name']); ?>" id="<?php echo htmlentities($form_group['name']); ?>" <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): ?>checked<?php endif; ?> <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>><span></span>
        </label>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-tags-input form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-datetimepicker form-control" type="text" id="<?php echo htmlentities($form_group['name']); ?>" name="<?php echo htmlentities($form_group['name']); ?>" value="<?php echo htmlentities((isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:'')); ?>" placeholder="<?php echo htmlentities($form_group['format']); ?>" data-locale="zh-cn" data-format="<?php echo !empty($form_group['format']) ? htmlentities($form_group['format']) :  'HH:mm:ss'; ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="form-control" id="<?php echo htmlentities($form_group['name']); ?>" rows="7" name="<?php echo htmlentities($form_group['name']); ?>" placeholder="<?php echo htmlentities((isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请输入'.$form_group['title'])); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>><?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?></textarea>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <script id="<?php echo htmlentities($form_group['name']); ?>" class="js-ueditor" name="<?php echo htmlentities($form_group['name']); ?>" type="text/plain"><?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?></script>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form_group['name']); ?>"><?php echo htmlentities(htmlspecialchars($form_group['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="form-control js-wangeditor" name="<?php echo htmlentities($form_group['name']); ?>" data-img-ext="<?php echo config('upload_image_ext'); ?>" id="<?php echo htmlentities($form_group['name']); ?>" rows="15" placeholder="请输入<?php echo htmlentities($form_group['title']); ?>"><?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?></textarea>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
                            ...
                            <?php break; default: ?>
                            <?php echo extend_form_item($form_group, $_layout); ?>
                        <?php endswitch; ?>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            ...
                                            <?php break; case "hidden": ?>
                                                ...
                                                <div class="form-group hidden <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" value='<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:"")); ?>' class="form-control" id="<?php echo htmlentities($form['name']); ?>">
</div>
                                            <?php break; case "icon": ?>
    ...
    <div class="col-xs-12">
        <div class="input-group js-icon-picker">
            <span class="input-group-addon icon" data-toggle="tooltip" data-placement="bottom" data-original-title="点击选择图标"><i class="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'fa fa-plus-circle')); ?>"></i></span>
            <input class="form-control icon_input" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="请选择图标" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            <span class="input-group-addon delete-icon" data-toggle="tooltip" data-placement="bottom" data-original-title="删除图标"><i class="fa fa-times"></i></span>
        </div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12 js-upload-image">
        <div id="file_list_<?php echo htmlentities($form['name']); ?>" class="uploader-list">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): ?>
            <div class="file-item thumbnail">
                <img data-original="<?php echo htmlentities(get_file_path($form['value'])); ?>" src="<?php echo htmlentities(get_thumb($form['value'])); ?>" width="100">
                <i class="fa fa-times-circle remove-picture"></i>
            </div>
            <?php endif; ?>
        </div>
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" data-multiple="false" data-watermark='<?php echo htmlentities((isset($form["watermark"]) && ($form["watermark"] !== '')?$form["watermark"]:"")); ?>' data-thumb='<?php echo htmlentities((isset($form["thumb"]) && ($form["thumb"] !== '')?$form["thumb"]:"")); ?>' data-size="<?php echo htmlentities((isset($form['size']) && ($form['size'] !== '')?$form['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form["ext"]) && ($form["ext"] !== '')?$form["ext"]:"")); ?>' id="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form['name']); ?>">上传单张图片</div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12 js-upload-images">
        ...
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" data-multiple="true" data-watermark='<?php echo htmlentities((isset($form["watermark"]) && ($form["watermark"] !== '')?$form["watermark"]:"")); ?>' data-thumb='<?php echo htmlentities((isset($form["thumb"]) && ($form["thumb"] !== '')?$form["thumb"]:"")); ?>' data-size="<?php echo htmlentities((isset($form['size']) && ($form['size'] !== '')?$form['size']:0)); ?>" data-ext='<?php echo htmlentities((isset($form["ext"]) && ($form["ext"] !== '')?$form["ext"]:"")); ?>' id="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
        <div id="picker_<?php echo htmlentities($form['name']); ?>">上传多张图片</div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
                                            ...
                                            <?php break; case "jcrop": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> js-jcrop-interface <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12 uploader-list">
        <div class="file-item thumbnail" <?php echo !empty($form['value']) ? htmlentities($form['value']) : "style='display:none'"; ?>>
            <img data-original="<?php echo htmlentities(get_file_path($form['value'])); ?>" src="<?php echo htmlentities(get_thumb($form['value'])); ?>" width="100">
            <i class="fa fa-times-circle remove-picture"></i>
        </div>
        <div class="clearfix"></div>
        ...
        <input type="hidden" class="js-jcrop-cut-info" value="">
        <input type="file" class="hidden js-jcrop-file" accept="image/jpg,image/jpeg,image/bmp,image/png,image/gif" value="">
        <input type="hidden" class="js-jcrop-input" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-popin">
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    ...
                    <div class="block-content push-20">
                        <div class="jcrop-preview-parent" <?php echo !empty($form['value']) ? htmlentities($form['value']) : "style='display:none'"; ?>>
                            <img src="<?php echo htmlentities(get_file_path($form['value'])); ?>" class="jcrop-preview" />
                        </div>
                        <div class="jcrop-img">
                            <img src="<?php echo htmlentities(get_file_path($form['value'])); ?>" data-id="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" data-watermark='<?php echo htmlentities((isset($form["watermark"]) && ($form["watermark"] !== '')?$form["watermark"]:"")); ?>' data-thumb='<?php echo htmlentities((isset($form["thumb"]) && ($form["thumb"] !== '')?$form["thumb"]:"")); ?>' data-options='<?php echo htmlentities((isset($form['options']) && ($form['options'] !== '')?$form['options']:"")); ?>' class="js-jcrop" style="display: none;" alt="">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <!-- END Pop In Modal -->
                                            ...
                                            <?php break; case "linkage": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(clear_js($form['title'])); ?></label>
    <div class="col-xs-12">
        <select class="js-select2 form-control select-linkage" name="<?php echo htmlentities($form['name']); ?>" id="<?php echo htmlentities($form['name']); ?>" data-allow-clear="true" data-placeholder="请选择一项" data-url="<?php echo htmlentities((isset($form['ajax_url']) && ($form['ajax_url'] !== '')?$form['ajax_url']:'')); ?>" data-param="<?php echo htmlentities((isset($form['param']) && ($form['param'] !== '')?$form['param']:$form['name'])); ?>" data-next-items="<?php echo htmlentities($form['next_items']); ?>" data-extra-param="<?php echo htmlentities((isset($form['extra_param']) && ($form['extra_param'] !== '')?$form['extra_param']:'')); ?>">
            <option></option>
            <?php if(is_array($form['options']) || $form['options'] instanceof \think\Collection || $form['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($key); ?>" <?php if(($form['value'] == (string)$key)): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
...
<div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="select-box">
        <select class="js-select2 form-control select-linkages" id="linkages_<?php echo htmlentities($form['name']); ?>_1" data-token="<?php echo htmlentities($form['token']); ?>" data-pidkey="<?php echo htmlentities((isset($form['pid']) && ($form['pid'] !== '')?$form['pid']:'pid')); ?>" data-next-level="2" data-next-level-id="linkages_<?php echo htmlentities($form['name']); ?>_2">
            <option value="">请选择：</option>
            <?php if(is_array($level_one) || $level_one instanceof \think\Collection || $level_one instanceof \think\Paginator): $i = 0; $__LIST__ = $level_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
            <option value="<?php echo htmlentities($option[$form['key']]); ?>" <?php if((isset($level_key[1]) && $level_key[1] == (string)$option[$form['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form['option']]); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
    ...
    <?php if($form['level'] == '2'): ?>
    <div class="select-box">
        <select class="js-select2 form-control" name="<?php echo htmlentities($form['name']); ?>" id="linkages_<?php echo htmlentities($form['name']); ?>_2">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['1']) || (($level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator ) && $level_data['1']->isEmpty()))): if(is_array($level_data['1']) || $level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form['key']]); ?>" <?php if(($form['value'] == (string)$option[$form['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </select>
    </div>
    ...
    <div class="select-box">
        <select class="js-select2 form-control select-linkages" id="linkages_<?php echo htmlentities($form['name']); ?>_2" data-token="<?php echo htmlentities($form['token']); ?>" data-pidkey="<?php echo htmlentities((isset($form['pid']) && ($form['pid'] !== '')?$form['pid']:'pid')); ?>" data-next-level="3" data-next-level-id="linkages_<?php echo htmlentities($form['name']); ?>_3">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['1']) || (($level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator ) && $level_data['1']->isEmpty()))): if(is_array($level_data['1']) || $level_data['1'] instanceof \think\Collection || $level_data['1'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form['key']]); ?>" <?php if((isset($level_key[2]) && $level_key[2] == (string)$option[$form['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </select>
    </div>
    <div class="select-box">
        <select class="js-select2 form-control" name="<?php echo htmlentities($form['name']); ?>" id="linkages_<?php echo htmlentities($form['name']); ?>_3">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['2']) || (($level_data['2'] instanceof \think\Collection || $level_data['2'] instanceof \think\Paginator ) && $level_data['2']->isEmpty()))): if(is_array($level_data['2']) || $level_data['2'] instanceof \think\Collection || $level_data['2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form['key']]); ?>" <?php if(($form['value'] == (string)$option[$form['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="select-box">
        <select class="js-select2 form-control select-linkages" id="linkages_<?php echo htmlentities($form['name']); ?>_3" data-token="<?php echo htmlentities($form['token']); ?>" data-pidkey="<?php echo htmlentities((isset($form['pid']) && ($form['pid'] !== '')?$form['pid']:'pid')); ?>" data-next-level="4" data-next-level-id="linkages_<?php echo htmlentities($form['name']); ?>_4">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['2']) || (($level_data['2'] instanceof \think\Collection || $level_data['2'] instanceof \think\Paginator ) && $level_data['2']->isEmpty()))): if(is_array($level_data['2']) || $level_data['2'] instanceof \think\Collection || $level_data['2'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form['key']]); ?>" <?php if((isset($level_key[3]) && $level_key[3] == (string)$option[$form['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
        </select>
    </div>
    <div class="select-box">
        <select class="js-select2 form-control" name="<?php echo htmlentities($form['name']); ?>" id="linkages_<?php echo htmlentities($form['name']); ?>_4">
            <option value="">请选择：</option>
            <?php if(!(empty($level_data['3']) || (($level_data['3'] instanceof \think\Collection || $level_data['3'] instanceof \think\Paginator ) && $level_data['3']->isEmpty()))): if(is_array($level_data['3']) || $level_data['3'] instanceof \think\Collection || $level_data['3'] instanceof \think\Paginator): $i = 0; $__LIST__ = $level_data['3'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo htmlentities($option[$form['key']]); ?>" <?php if(($form['value'] == (string)$option[$form['key']])): ?>selected<?php endif; ?>><?php echo clear_js($option[$form['option']]); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-masked form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" data-format="<?php echo htmlentities((isset($form['format']) && ($form['format'] !== '')?$form['format']:'')); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="<?php echo htmlentities((isset($form['format']) && ($form['format'] !== '')?$form['format']:'')); ?>" <?php echo htmlentities((isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:'')); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="form-control" type="number" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="<?php echo htmlentities((isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title'])); ?>" <?php if(isset($form['min']) && $form['min'] !== ''): ?>min="<?php echo htmlentities($form['min']); ?>"<?php endif; if(isset($form['max']) && $form['max'] !== ''): ?>max="<?php echo htmlentities($form['max']); ?>"<?php endif; if(isset($form['step']) && $form['step'] !== ''): ?>step="<?php echo htmlentities($form['step']); ?>"<?php endif; ?> <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="form-control" type="password" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="<?php echo htmlentities((isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title'])); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12">
        <?php if(is_array($form['options']) || $form['options'] instanceof \think\Collection || $form['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
        <label class="css-input css-radio css-radio-<?php echo htmlentities((isset($form['attr']['color']) && ($form['attr']['color'] !== '')?$form['attr']['color']:'primary')); ?> css-radio-<?php echo htmlentities((isset($form['attr']['size']) && ($form['attr']['size'] !== '')?$form['attr']['size']:'sm')); ?> push-10-r  <?php echo htmlentities((isset($form['extra_label_class']) && ($form['extra_label_class'] !== '')?$form['extra_label_class']:'')); ?>">
            <input type="radio" name="<?php echo htmlentities($form['name']); ?>" id="<?php echo htmlentities($form['name']); ?><?php echo htmlentities($i); ?>" value="<?php echo htmlentities($key); ?>" <?php $key = (string)$key; if($key == (isset($form['value']) && ($form['value'] !== '')?$form['value']:'')): ?>checked<?php endif; ?> <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            <span></span> <?php echo htmlspecialchars($option); ?>
        </label>
        <?php endforeach; endif; else: echo "" ;endif; if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-rangeslider form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" data-input-values-separator="<?php echo htmlentities((isset($form['input_values_separator']) && ($form['input_values_separator'] !== '')?$form['input_values_separator']:';')); ?>" data-min="<?php echo htmlentities((isset($form['min']) && ($form['min'] !== '')?$form['min']:'')); ?>" data-max="<?php echo htmlentities((isset($form['max']) && ($form['max'] !== '')?$form['max']:'')); ?>" data-grid="<?php echo htmlentities((isset($form['grid']) && ($form['grid'] !== '')?$form['grid']:'')); ?>" data-grid-num="<?php echo htmlentities((isset($form['grid_num']) && ($form['grid_num'] !== '')?$form['grid_num']:'')); ?>" data-grid-snap="<?php echo htmlentities((isset($form['grid_snap']) && ($form['grid_snap'] !== '')?$form['grid_snap']:'')); ?>" data-from="<?php echo htmlentities((isset($form['from']) && ($form['from'] !== '')?$form['from']:'')); ?>" data-from-fixed="<?php echo htmlentities((isset($form['from_fixed']) && ($form['from_fixed'] !== '')?$form['from_fixed']:'')); ?>" data-type="<?php echo htmlentities((isset($form['double']) && ($form['double'] !== '')?$form['double']:'')); ?>" data-to="<?php echo htmlentities((isset($form['to']) && ($form['to'] !== '')?$form['to']:'')); ?>" data-to-fixed="<?php echo htmlentities((isset($form['to_fixed']) && ($form['to_fixed'] !== '')?$form['to_fixed']:'')); ?>" data-step="<?php echo htmlentities((isset($form['step']) && ($form['step'] !== '')?$form['step']:'')); ?>" data-from-min="<?php echo htmlentities((isset($form['from_min']) && ($form['from_min'] !== '')?$form['from_min']:'')); ?>" data-from-max="<?php echo htmlentities((isset($form['from_max']) && ($form['from_max'] !== '')?$form['from_max']:'')); ?>" data-to-min="<?php echo htmlentities((isset($form['to_min']) && ($form['to_min'] !== '')?$form['to_min']:'')); ?>" data-to-max="<?php echo htmlentities((isset($form['to_max']) && ($form['to_max'] !== '')?$form['to_max']:'')); ?>" data-from-shadow="<?php echo htmlentities((isset($form['from_shadow']) && ($form['from_shadow'] !== '')?$form['from_shadow']:'')); ?>" data-to-shadow="<?php echo htmlentities((isset($form['to_shadow']) && ($form['to_shadow'] !== '')?$form['to_shadow']:'')); ?>" data-keyboard="<?php echo htmlentities((isset($form['keyboard']) && ($form['keyboard'] !== '')?$form['keyboard']:'')); ?>" data-keyboard-step="<?php echo htmlentities((isset($form['keyboard_step']) && ($form['keyboard_step'] !== '')?$form['keyboard_step']:'')); ?>" data-values="<?php echo htmlentities((isset($form['values']) && ($form['values'] !== '')?$form['values']:'')); ?>" data-prefix="<?php echo htmlentities((isset($form['prefix']) && ($form['prefix'] !== '')?$form['prefix']:'')); ?>" data-disable="<?php echo htmlentities((isset($form['disable']) && ($form['disable'] !== '')?$form['disable']:'')); ?>" data-postfix="<?php echo htmlentities((isset($form['postfix']) && ($form['postfix'] !== '')?$form['postfix']:'')); ?>" data-min-interval="<?php echo htmlentities((isset($form['min_interval']) && ($form['min_interval'] !== '')?$form['min_interval']:'')); ?>" data-max-interval="<?php echo htmlentities((isset($form['max_interval']) && ($form['max_interval'] !== '')?$form['max_interval']:'')); ?>" data-drag-interval="<?php echo htmlentities((isset($form['drag_interval']) && ($form['drag_interval'] !== '')?$form['drag_interval']:'')); ?>" data-prettify-enabled="<?php echo htmlentities((isset($form['prettify_enabled']) && ($form['prettify_enabled'] !== '')?$form['prettify_enabled']:'')); ?>" data-prettify-separator="<?php echo htmlentities((isset($form['prettify_separator']) && ($form['prettify_separator'] !== '')?$form['prettify_separator']:'')); ?>" data-max-postfix="<?php echo htmlentities((isset($form['max_postfix']) && ($form['max_postfix'] !== '')?$form['max_postfix']:'')); ?>" data-decorate-both="<?php echo htmlentities((isset($form['decorate_both']) && ($form['decorate_both'] !== '')?$form['decorate_both']:'')); ?>" data-values-separator="<?php echo htmlentities((isset($form['values_separator']) && ($form['values_separator'] !== '')?$form['values_separator']:'')); ?>" data-hide-min-max="<?php echo htmlentities((isset($form['hide_min_max']) && ($form['hide_min_max'] !== '')?$form['hide_min_max']:'')); ?>" data-hide-from-to="<?php echo htmlentities((isset($form['hide_from_to']) && ($form['hide_from_to'] !== '')?$form['hide_from_to']:'')); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <select class="js-select2 form-control" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" data-allow-clear="true" data-placeholder="<?php echo htmlentities((isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请选择一项')); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            <option></option>
            <?php if(is_array($form['options']) || $form['options'] instanceof \think\Collection || $form['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
            <option value="<?php echo htmlentities($key); ?>" <?php if(((string)$form['value'] == (string)$key)): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <select class="js-select2 form-control" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>[]" data-allow-clear="true" data-placeholder="<?php echo htmlentities((isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请选择一项或多项')); ?>" multiple="multiple" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            ...
            <option value="<?php echo htmlentities($key); ?>" <?php if(in_array(($key), is_array($form['value'])?$form['value']:explode(',',$form['value']))): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
                                            ...
                                            <?php break; case "sort": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo htmlentities((isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12')); ?> col-md-<?php echo htmlentities((isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12')); ?> col-sm-<?php echo htmlentities((isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12')); ?> col-xs-<?php echo htmlentities((isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12')); ?> <?php echo htmlentities((isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:'')); ?>" id="form_group_<?php echo htmlentities($form['name']); ?>">
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>">
    <div class="col-xs-12">
        <?php if(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty())): ?>
            <div class="form-control-static">暂无数据，无法排序</div>
        <?php else: ?>
            <div class="dd nestable" data-name="<?php echo htmlentities($form['name']); ?>">
                <ol class="dd-list">
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <div class="form-control-static"><?php echo htmlentities(htmlspecialchars((isset($form['value']) && ($form['value'] !== '')?$form['value']:''))); ?></div>
        <?php if(!(empty($form['hidden']) || (($form['hidden'] instanceof \think\Collection || $form['hidden'] instanceof \think\Paginator ) && $form['hidden']->isEmpty()))): ?>
        <input type="hidden" name="<?php echo htmlentities($form['name']); ?>" value='<?php echo htmlentities((isset($form['hidden']) && ($form['hidden'] !== '')?$form['hidden']:"")); ?>'>
        <?php endif; if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="js-summernote form-control" id="<?php echo htmlentities($form['name']); ?>" data-width="<?php echo htmlentities((isset($form['width']) && ($form['width'] !== '')?$form['width']:'100%')); ?>" data-height="<?php echo htmlentities((isset($form['height']) && ($form['height'] !== '')?$form['height']:400)); ?>" name="<?php echo htmlentities($form['name']); ?>" placeholder="请输入<?php echo htmlentities($form['title']); ?>"><?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?></textarea>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <label class="css-input switch switch-<?php echo htmlentities((isset($form['attr']['size']) && ($form['attr']['size'] !== '')?$form['attr']['size']:'sm')); ?> switch-<?php echo htmlentities((isset($form['attr']['color']) && ($form['attr']['color'] !== '')?$form['attr']['color']:'primary')); ?> switch-<?php echo htmlentities((isset($form['attr']['shape']) && ($form['attr']['shape'] !== '')?$form['attr']['shape']:'rounded')); ?> <?php echo htmlentities((isset($form['extra_label_class']) && ($form['extra_label_class'] !== '')?$form['extra_label_class']:'')); ?>" title="开启/关闭">
            <input type="checkbox" name="<?php echo htmlentities($form['name']); ?>" id="<?php echo htmlentities($form['name']); ?>" <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): ?>checked<?php endif; ?> <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>><span></span>
        </label>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-tags-input form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <input class="js-datetimepicker form-control" type="text" id="<?php echo htmlentities($form['name']); ?>" name="<?php echo htmlentities($form['name']); ?>" value="<?php echo htmlentities((isset($form['value']) && ($form['value'] !== '')?$form['value']:'')); ?>" placeholder="<?php echo htmlentities($form['format']); ?>" data-locale="zh-cn" data-format="<?php echo !empty($form['format']) ? htmlentities($form['format']) :  'HH:mm:ss'; ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="form-control" id="<?php echo htmlentities($form['name']); ?>" rows="7" name="<?php echo htmlentities($form['name']); ?>" placeholder="<?php echo htmlentities((isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title'])); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>><?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?></textarea>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <script id="<?php echo htmlentities($form['name']); ?>" class="js-ueditor" name="<?php echo htmlentities($form['name']); ?>" type="text/plain"><?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?></script>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo htmlentities($form['name']); ?>"><?php echo htmlentities(htmlspecialchars($form['title'])); ?></label>
    <div class="col-xs-12">
        <textarea class="form-control js-wangeditor" name="<?php echo htmlentities($form['name']); ?>" data-img-ext="<?php echo config('upload_image_ext'); ?>" id="<?php echo htmlentities($form['name']); ?>" rows="15" placeholder="请输入<?php echo htmlentities($form['title']); ?>"><?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?></textarea>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
                                            ...
                                            <?php break; default: ?>
                                            <?php echo extend_form_item($form, $_layout); ?>
                                        <?php endswitch; ?>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php endif; ?>
                            ...
                            <?php echo (isset($extra_html_form_bottom) && ($extra_html_form_bottom !== '')?$extra_html_form_bottom:''); ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php endif; if(!(empty($_icon) || (($_icon instanceof \think\Collection || $_icon instanceof \think\Paginator ) && $_icon->isEmpty()))): ?>
    <div id="icon_tab" style="display:none">
        ...
        <ul  class="nav nav-tabs nav-simple">
            ...
            <?php if(is_array($_icons) || $_icons instanceof \think\Collection || $_icons instanceof \think\Paginator): $i = 0; $__LIST__ = $_icons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$icon): $mod = ($i % 2 );++$i;?>
            <li>
                <a href="#icon<?php echo htmlentities($icon['id']); ?>" data-toggle="tab"><?php echo htmlentities($icon['name']); ?></a>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <div class="tab-content js-icon-content" style="padding: 10px">
            ...
            <?php if(is_array($_icons) || $_icons instanceof \think\Collection || $_icons instanceof \think\Paginator): $i = 0; $__LIST__ = $_icons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$icon): $mod = ($i % 2 );++$i;?>
            <div class="tab-pane fade" id="icon<?php echo htmlentities($icon['id']); ?>">
                <?php echo (isset($icon['html']) && ($icon['html'] !== '')?$icon['html']:'暂无图标'); ?>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
...
<!--页面js-->
    ...
    <script src="/static/libs/ueditor/ueditor.config.js?v=<?php echo config('asset_version'); ?>"></script>
    <script src="/static/libs/ueditor/ueditor.all.min.js?v=<?php echo config('asset_version'); ?>"></script>
    <?php endif; if(!(empty($_ckeditor) || (($_ckeditor instanceof \think\Collection || $_ckeditor instanceof \think\Paginator ) && $_ckeditor->isEmpty()))): ?>
    <script src="/static/libs/ckeditor/ckeditor.js?v=<?php echo config('asset_version'); ?>"></script>
    ...
    <?php endforeach; endif; else: echo "" ;endif; if(is_array($extend_js_list) || $extend_js_list instanceof \think\Collection || $extend_js_list instanceof \think\Paginator): $i = 0; $__LIST__ = $extend_js_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <script src="<?php echo htmlentities($v); ?>?v=<?php echo config('asset_version'); ?>"></script>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    <?php endforeach; endif; else: echo "" ;endif; ?>
