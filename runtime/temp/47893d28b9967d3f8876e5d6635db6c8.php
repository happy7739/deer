<?php /*a:4:{s:56:"F:\Project\deer\application\index\view\news\details.html";i:1590561175;s:58:"F:\Project\deer\application\index\view\public\details.html";i:1590561231;s:54:"F:\Project\deer\application\index\view\public\nav.html";i:1590484295;s:57:"F:\Project\deer\application\index\view\public\footer.html";i:1590382130;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="banner_n">
        ...
        <div class="main">
            <div class="locat">
                ...
                <a href="<?php echo url('index/news/index'); ?>">新闻资讯</a>
                > 详细
            </div>
            
<div class="about_con">
    <p style="text-align: center"><?php echo htmlentities($data['title']); ?></p>
    <p style="text-align: center">发布日期：<?php echo htmlentities($data['time']); ?></p>
    <?php echo $data['text']; ?>
