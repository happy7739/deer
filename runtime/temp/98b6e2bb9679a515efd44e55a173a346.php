<?php /*a:6:{s:54:"F:\Project\deer\application\admin\view\menu\index.html";i:1551348862;s:50:"F:\Project\deer\application\admin\view\layout.html";i:1579404556;s:47:"../application/common/builder/aside/layout.html";i:1551348862;s:54:"../application/common/builder/aside/blocks/recent.html";i:1551348862;s:54:"../application/common/builder/aside/blocks/online.html";i:1551348862;s:54:"../application/common/builder/aside/blocks/switch.html";i:1551348862;}*/ ?>
<!DOCTYPE html>
...
<link href="/static/libs/jquery-nestable/jquery.nestable.css" rel="stylesheet" type="text/css" />
            ...
            <div class="block">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li <?php if($tab_nav['curr_tab'] == $key): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo htmlentities($tab['url']); ?>"><?php echo htmlentities($tab['title']); ?></a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane active">
                        ...
                        <div class="row data-table-toolbar">
                            <div class="col-sm-12">
                                <form action="<?php echo htmlentities(app('request')->url()); ?>" method="get">
                                <div class="toolbar-btn-action">
                                    <a title="新增" class="btn btn-primary" href="<?php echo url('add', ['module' => app('request')->param('group')]); ?>"><i class="fa fa-plus-circle"></i> 新增</a>
                                    ...
                                    <span class="form-inline">
                                        <input class="form-control" type="text" name="max" value="<?php echo htmlentities((app('request')->get('max') ?: '')); ?>" placeholder="显示层数">
                                    </span>
                                </div>
                                </form>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div id="sortable" class="connectedSortable push-20">
                                        ...
                                        <div class="sortable-item pull-left">
                                            <input type="hidden" name="sort[]" value="<?php echo htmlentities($key); ?>">
                                            <i class="<?php echo htmlentities($module['icon']); ?>"></i> <?php echo htmlentities($module['title']); ?>
                                        </div>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
...
<script src="/static/libs/jquery-nestable/jquery.nestable.js"></script>
